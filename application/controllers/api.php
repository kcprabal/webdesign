...
class Api extends CI_Controller
{
    ...
    public function register()
    {
        ...
        $this->output->set_output(json_encode(['result' => 0,'error' => 'user not set']));
    }
    ...
    public function create_todo()
    {
        ...
        $this->form_validation->set_rules('content','Content','required|max_lenght[255]');
    ...
    public function create_note()
    {
        ...
        $this->form_validation->set_rules('title','Title','required|max_lenght[50]');
        $this->form_validation->set_rules('content','Content','required|max_lenght[500]');
        ...
        $this->output->set_output(json_encode([
            'result' => 0,
            'error' => 'Could not insert record in Note']));
    ...
    public function update_note()
    {
        ...
        // Do not need to check the affected rows
        $this->output->set_output(json_encode(['result' => 1]));
        return false;
    }
