...
class CRUD_model extends CI_Model
{
     ...
     * Custom: $this->user_model->get(array('age' => '32'))
     */
    ...
    /**
     * @param array $data
     * @usage  $result = $this->user_model->insert(['Login' => 'Jetro']);
     */
    ...
    /**
     * @usage $result = $this->user_model->update(['login' => 'Peggy'],  2);
     * 
    ...
    public function update($data, $where)
    {
        ...
        {
            die("You must pass a second paramter to the Update() method");
        }
